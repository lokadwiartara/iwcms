...
<script src="<?php echo get_template_directory(dirname(__FILE__), 'js');?>/underscore-min.js"></script>
...
<script src="<?php echo get_template_directory(dirname(__FILE__), 'js/') ;?>site.js"></script>
</body>
</html>
