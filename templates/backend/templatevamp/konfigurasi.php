                     ...
                     <fieldset>
                        <div class="control-group">                     
                          ...
                          <div class="controls">
                            ...
                            <p class="help-block">Anda bisa mengganti alamat website, dengan nama domain Anda sendiri atau dengan sub domain website Anda. Butuh bantuan ? Silahkan hubungi support@kaffahbiz.co.id</p>
                          </div> <!-- /controls -->       
